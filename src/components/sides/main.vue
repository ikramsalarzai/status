    ...
    <div class="row">
      <div class="col-lg-12 col-sm-12 pt-4">
        <div class="slider d-block d-sm-none">
          ...
          >
            <div class="carousel-inner" style="border-radius: 10px">
              <div
                class="carousel-item"
                v-for="(item, id) in slides.data"
                :key="id"
                :class="{ active: id == 0 }"
              >
                <img
                  class="d-block w-100 c_image"
                  :src="'https://dashboard.fkheart.com/' + item.image"
                  alt="first slide"
                />
              </div>
            </div>
        ...
        >
            ...
            <div class="card-body">
              ...
              <span class="d-flex justify-content-around">
                ...
                <div>
                  ...
                  <div class="tooltip bs-tooltip-top" role="tooltip">
                    <div class="arrow"></div>
                    <div class="tooltip-inner">Copy it</div>
                  </div>
                </div>
              </span>
            </div>
          ...
          <div v-else class="card mb-2 position-relative">
            <div class="card-body">
              <span>
                <h5 class="card-title text-capitalize">
                  <img
                ...
                >
                  ...
                  >
                    <span class="dropdown-item" @click="deleted(user.id)"
                      >Delete the status</span
                    >
                  </div>
                </div>
              </span>
              ...
              <article
                id="cont1"
                class="card-text bg-light contentcard text-right pb-4 p-2"
        ...
        <div
          class="card mb-2 mt-4 center"
          v-if="infos.data != undefined && infos.data.length == 0"
        >
...
export default {
   ...
   myFunction(content) {
    ...
    heart(id) {
      ...
      if (this.tokenvalue != null) {
        axios
          .post(
            "https://dashboard.fkheart.com/api/add/favourite/1",
            {
              status_id: id,
            },
    ...
    //for delete
    deleted(videoid) {
      if (videoid == this.u_id) {
        confirm("are you sure to delete it");
        {
          axios
            .delete("https://dashboard.fkheart.com/api/status/" + videoid)
            .then((response) => {
              // this.infos.splice(videoid, 1);
  ...
  created() {
    this.u_id = localStorage.getItem("user_id"); // to get the log in id of the user
    this.tokenvalue = localStorage.getItem("token"); //to get the token
