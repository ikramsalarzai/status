<template>
  <div class="container-fluid">
          <app-nav  v-bind:categories="categories"></app-nav>
    <div class="row p-5 mt-3 text-justify  text" style="background-color:#B9F7E9"> 
            <div class="col-lg-12">
                <h3> Privacy Policy</h3>
            </div>
            <div class="col-lg-10">
                <p>
                   <h5> Privacy Policy for Fk Heart</h5>
At Fk Heart , accessible from https://fkheart.com/ one of our main priorities is the privacy of our visitors. 
This Privacy Policy document contains types of information that is collected and recorded by Fk Heart 
and how we use it.
...
to the information that they shared and/or collect in Fk Heart . This policy is not applicable to any 
...
<h6>How we use your information</h6> We use the information we collect in various ways, including to: <br>
<ul>
  <li>
...
Fk Heart follows a standard procedure of using log files. These files log visitors when they visit websites. 
...
Like any other website, Fk Heart uses ‘cookies. These cookies are used to store information including 
...
<br><br>
<h6>
Advertising Partners Privacy Policies</h6>
You may consult this list to find the Privacy Policy for each of the advertising partners of Fk Heart .
Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that 
are used in their respective advertisements and links that appear on Fk Heart , which are sent directly to 
...
Note that Fk Heart has no access to or control over these cookies that are used by third-party 
advertisers. <br><br>
<h6>Third Party Privacy Policies </h6>
Fk Heart ’s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to 
...
collected to another organization, or directly to you, under certain conditions. </li></ol>
If you make a request, we have one month to respond to you. If you would like to exercise any of these 
rights, please contact us. 
<br> <br>
...
Fk Heart does not knowingly collect any Personal Identifiable Information from children under the age 
of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such 
